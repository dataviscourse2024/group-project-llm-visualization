...
const sendMessage = () => {
  if (newMessage.value.trim() !== '') {
    const date = new Date();
    userMessages.value[date.getTime()] = (newMessage.value);
    newMessage.value = '';
